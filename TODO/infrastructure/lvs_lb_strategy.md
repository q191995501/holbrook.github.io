...
![VS/NAT](images/tools/lvs_lb_strategy/vs-nat.jpg)
...
![VS/TUN](images/tools/lvs_lb_strategy/vs-tun.jpg)

VS/TUN与VS/NAT的工作机制大体上相同，区别在于：

1. 调度器转发报文的时候进行了协议的二次封装，真实的服务器接收到请求后先进行解包。过程如下图所示：

   ![VS/TUN example](images/tools/lvs_lb_strategy/vs-tun-flow.jpg)
...
![VS/DR](images/tools/lvs_lb_strategy/vs-dr.jpg)
...
![VS/TUN](images/tools/lvs_lb_strategy/vs-dr-flow.jpg)
